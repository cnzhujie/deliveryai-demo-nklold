  ...
  zh: {
    translation: {
      common: {
        ...
        aria_console: '演示控制台',
        aria_lang: '切换语言',
        aria_dark_mode: '切换至夜间模式',
        aria_light_mode: '切换至日间模式',
        aria_close: '关闭',
        aria_reduce: '减少',
        aria_increase: '增加',
      ...
      message: {
        ...
        reset: '演示已重置',
        welcome: '欢迎进入概念演示',
        dark_mode_on: '已切换为夜间模式',
        dark_mode_off: '已切换为日间模式',
  ...
  en: {
    translation: {
      ...
      message: {
        ...
        dark_mode_on: 'Switched to dark mode',
        dark_mode_off: 'Switched to light mode',
